...
def crawlWeb(request, keyword, breadth, depth):
    import sys
    reload(sys)
    sys.setdefaultencoding('utf8')

    spiderconfig = SpiderConfig()
    spiderconfig.setConfig('googlescholar_base', 'https://c3.glgooo.top/scholar?hl=zh-CN')
    spiderconfig.setConfig('keyword', keyword)
    spiderconfig.setConfig('breadth', breadth)
    spiderconfig.setConfig('depth', depth)
...
if __name__ == '__main__':
    ...
    spiderconfig = SpiderConfig()
    spiderconfig.setConfig('googlescholar_base', 'https://c3.glgooo.top/scholar?hl=zh-CN')
    spiderconfig.setConfig('keyword', 'cloud')
    spiderconfig.setConfig('breadth', 3)
